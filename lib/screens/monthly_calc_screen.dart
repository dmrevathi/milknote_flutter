...
class _MonthlyCalcScreenState extends State<MonthlyCalcScreen> {
  ...
  double get _grandTotal =>
      _data.values.fold(0.0, (sum, entry) => sum + (entry[0]) + (entry[1]));
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await ApiService.saveCalcReport(auth.userId!, _reportName, total, dataMap,
      ...
      showDialog(
          ...
          builder: (_) => AlertDialog(
                ...
                content:
                    Text('"$_reportName" சேமிக்கப்பட்டது!\nமொத்தம்: $total L'),
                actions: [
                  TextButton(
                      onPressed: () {
        ...
        builder: (_) => AlertDialog(
              ...
              content: TextField(
                  ...
                  decoration: const InputDecoration(
                      hintText: 'எ.கா. அக்டோபர் அறிக்கை')),
              actions: [
                TextButton(
  ...
  void _showPicker(int day, int idx, bool isFrac) {
    ...
    final current =
        isFrac ? (_getVal(day, idx) % 1) : _getVal(day, idx).floorToDouble();
            ...
            return Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                    child: _Cell(
                  label:
                      '.${((morning % 1) * 100).toInt().toString().padLeft(2, '0')}',
                ...
                Expanded(
                    child: _Cell(
                  label:
                      '.${((evening % 1) * 100).toInt().toString().padLeft(2, '0')}',
        ...
        Container(
          ...
          child: Column(children: [
            Text('🧮 மொத்தம்: ${_grandTotal.toStringAsFixed(2)} L',
                style: const TextStyle(
                    fontSize: 17, fontWeight: FontWeight.w800, color: kGreen)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _saving
                    ...
                    : Text(widget.reportId != null
                        ? '💾 அறிக்கையை புதுப்பிக்கவும்'
