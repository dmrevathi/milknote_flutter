...
class _MonthlyReportScreenState extends State<MonthlyReportScreen> {
  ...
  Future<void> _exportPdf(Map t) async {
    ...
    final milkPersonDisplay = _milkPersonName.isNotEmpty
        ? '$_milkPersonName - $_milkPersonPhone'
        : '-';
      ...
      build: (pw.Context ctx) => [
        ...
        pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
              pw.Text(
                  'Milk Note - ${t['sideBar']?['monthlyMilkRecord'] ?? 'Monthly Report'}',
                  style: pw.TextStyle(
        ...
        pw.Row(children: [
          ...
          pw.Expanded(
              child: _pdfInfoBox(labelCowPerson, '$cowName - $cowPhone')),
        ]),
        ...
        pw.Container(
          ...
          child: pw.Text(
              '$labelTotal: $_total ${t['monthlyMilkReport']?['liter_label'] ?? 'L'}',
              style: pw.TextStyle(
                  color: PdfColors.white,
                  fontSize: 16,
                  fontWeight: pw.FontWeight.bold),
